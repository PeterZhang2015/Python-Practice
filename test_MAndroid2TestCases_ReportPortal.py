...
class TestMAndroid2TestCases():
    ...
    handset_id = '9886734d5647434c32'
    testIMSI = '505025815954246'
    ...
    def setup_class(self):
        ...
        print ("handset_id is: ", handset_id)
    ...
    def test_MAndroid2_Relogin(self, rp_logger):

        rp_logger.info("Test case one: Relogin.")
        rp_logger.info("Step one: Confirming permissions.")
        ...
        rp_logger.info("Step two: Logout.")
        ...
        rp_logger.info("Step three: Relogin.")
        ...
        rp_logger.info("Step four: Check login result.")
    ...
    def MAndroid2_logout(self, rp_logger):

        rp_logger.info("Test case two: Logout.")
        rp_logger.info("Step one: Confirming permissions.")
...
if __name__ == '__main__':
    ...
    # Generate json report to report portal.
    executeCommand = "pytest -s -q --reportportal test_MAndroid2TestCases.py"
    output1 = os.system(executeCommand)
    print ("Generate json report command response", output1)
